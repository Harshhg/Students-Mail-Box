...
<div class="wrap">
  <header>
    <div class="container">
      ...
      <nav>
         <ul>
           <li><a href="admin_home.php" class="m1">Home Page</a></li>
          <li  ><a href="admin_inbox.php" class="m2">Inbox</a></li>
          <li class="current"><a href="admin_sentmail.php" class="m3">Sent Mail</a></li>
	 ...
	 <tr style="background-color: #ccffcc">  
         ...
         <td><b> <?php echo($receiver_name);?> </b></td>
          ...
          <td><b><?php echo($subject);?></b></td>
             <td> <a href = "admin_readsentmail.php ?msg=<?php echo $id;?>" >View Mail </a></td> 
